...
```
To find the value at which these two lines 
intersect algebraically by can setting equal to one another, solving for one variable then plugging that back into the equation to get the other variable. In this case these variables are coordinates.
...
We get when Square feet = 2846.047672
and sales price =372264.582495, is the point of intersection.
