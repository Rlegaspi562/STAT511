...
\*\*Are the number of bathrooms (𝑋2) and garage size (𝑋3) jointly significant in the MLR model? Conduct a partial F-test and conclude. Choose your own 𝛼.
...
\*\* we keep the variable we are most interested in and remove the other. we know there is some kind of multicolinearity issue with bed and baths, I am more interested in beds than baths.
...
We notice beds it no significant when in fact the reality is it SHOULD be significant
