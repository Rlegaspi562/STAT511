...
The estimated intercept coefficient will be zero if all standardized, so we can remove it from the model.
...
## d. Use the anova() function in R to test if sweetness ($X_{2}$) should be removed from the multiple

linear regression, i.e., test the difference between the full model and the reduced model.
