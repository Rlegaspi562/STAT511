...
$M$ = 4.925: The mean Rating when sweetness is level 2 for a 1 unit change in Moisture content increases by 4.925.
...
insigifnicant means we fail to rejet the null, should be parallel. cnsidering interaction term is unecessary.

the insignificant interactoin the regardless of using corner or non conrewr the valuation has the same effect on the price
...
if the higghest order is significant, but the ones in lower order have some that are insiginfacnt or significant we keep them.
